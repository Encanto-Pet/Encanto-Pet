    ...
    <style>
        ...
        * {
        ...
        .admin-product-preview {
            ...
            border-radius: 12px;
            background: #fff;
            box-shadow: 0 18px 38px rgba(39, 49, 64, 0.07);
        }
    ...
    <div class="main" id="admin-main">
        ...
        <div class="topbar">
            <div class="search-bar">
                <svg width="15" height="15" fill="none" viewBox="0 0 24 24">
                    ...
                    <path d="M21 21l-4.35-4.35" stroke="#aaa" stroke-width="2" stroke-linecap="round" />
                </svg>
        ...
        <div class="page active" id="page-produtos" style="position:relative">
            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:24px">
                ...
                <div
                    style="width:120px;height:120px;border-radius:50%;background:var(--yellow);overflow:hidden;display:flex;align-items:center;justify-content:center;margin-top:8px;flex-shrink:0">
                    <img src="{{ asset('assets/img/cachorro-feliz.svg') }}" alt=""
                        style="width:88%;height:88%;object-fit:contain">
                </div>
            </div>

            <div class="admin-product-create">
                <form class="admin-product-form" id="adminProductForm" action="/product/update/{{ $product->id }}" method="POST"
                    ...
                    <div class="admin-product-actions">
                        <button type="submit" class="admin-save-btn">Editar Produto</button>
                ...
                <aside class="admin-product-preview" aria-label="Prévia do produto">
                    <div class="admin-preview-image">
                        ...
                        <img id="adminPreviewImage" src="{{ asset('assets/img/cachorro-feliz.svg') }}"
